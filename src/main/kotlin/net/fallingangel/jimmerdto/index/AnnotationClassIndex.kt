...
val ANNOTATION_CLASS_INDEX = ID.create<String, Void>("net.fallingangel.jimmerdto.index.AnnotationClassIndex")

class AnnotationClassIndex : ScalarIndexExtension<String>() {
    private val indexer = DataIndexer<String, Void, FileContent> { file ->
